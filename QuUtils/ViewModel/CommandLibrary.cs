...
{
    /// <summary>
    /// A library that exposes commands in a WPF binding friendly manner
    /// </summary>
    [TypeDescriptionProvider(typeof(CommandLibraryDescriptionProvider))]
    public class CommandLibrary
    {
        /// <summary>
        /// Add a named command to the command library
        /// </summary>
        ...
        /// <summary>
        /// Remove a command from the command library
        /// </summary>
        /// <param name="commandName">The name of the command</param>
        ...
        /// </summary>
        private class CommandLibraryDescriptionProvider : TypeDescriptionProvider
        {
            /// <summary>
            /// Standard constructor
            /// </summary>
            public CommandLibraryDescriptionProvider()
                : this(TypeDescriptor.GetProvider(typeof(CommandLibrary)))
            {
            }
            ...
            public CommandLibraryDescriptionProvider(TypeDescriptionProvider parent)
                : base(parent)
            {
            }
            ...
            {
                return new CommandMapDescriptor(base.GetTypeDescriptor(objectType, instance), instance as CommandLibrary);
            }
        }
        ...
        private class CommandMapDescriptor : CustomTypeDescriptor
        {
            ...
            /// <summary>
            /// Get the properties for this command library
            /// </summary>
